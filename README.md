...
[`docs/dataset-shape.md`](docs/dataset-shape.md), generated from the archive and
...
five publication days produces **96 flags from 8,132 lot outcomes**; eligible
...
**Version 4 is implemented and measured.** It rejects duplicate structural and
...
and excludes both notices another notice corrects and notices announcing their
own cancellation, intended cancellation or suspension
...
successful run, but a multi-year replacement is not transactional. Those two
exclusions remove 27 lot outcomes from this archive and no flags — a fact about
this corpus, not a general guarantee. The mechanism is **unexercised against
real corrigenda**: only 1.6% of correction links resolve within five sampled
days. One flag has had its arithmetic re-derived; **none has completed the
